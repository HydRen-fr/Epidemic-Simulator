...
class Individu:
    ...
    def bouger(self, cosmos):
        ...
        if not(self.est_en_quarantaine) and VILLE_CENTRALE and random.random() < PROBABILITE_VOYAGE_VERS_VILLE:
        ...
        elif not(self.est_en_quarantaine) and COMMUNAUTES and random.random() < PROBABILITE_VOYAGE_VERS_COMMUNAUTE:
