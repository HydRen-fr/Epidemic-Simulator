...
class Guerison:
    @staticmethod
    def progresser_guerison_ou_mort(individu, cosmos):
        ...
        if individu.couleur == (255, 0, 0):  # Si l'individu est infecté
            ...
            if individu.temps_infecte >= individu.temps_guerison: # Si il est infecté depuis suffisamment longtemps
                if random.random() < cosmos.constantes_parametrables["LETALITE"]: # Petite chance de mourir en fonction du taux de létalité
